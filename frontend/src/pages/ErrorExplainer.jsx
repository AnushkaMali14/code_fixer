                    ...
                    {resultData?.issues && resultData.issues.length > 0 ? (
                        resultData.issues.map((issue, idx) => (
                            <motion.div
                                ...
                                className={`p-6 rounded-2xl border-l-[6px] shadow-sm bg-white dark:bg-gray-800 transition-all hover:shadow-md ${issue.type === 'Error' ? 'border-red-500' :
                                        issue.type === 'Warning' ? 'border-yellow-500' : 'border-blue-500'
                                    }`}
                            >
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex items-center space-x-3">
                                        <div className={`p-2 rounded-lg ${issue.type === 'Error' ? 'bg-red-50 dark:bg-red-900/20 text-red-600' : 'bg-blue-50 dark:bg-blue-900/20 text-blue-600'
                                            }`}>
                                    ...
                                    <span className={`text-[10px] font-black uppercase px-2 py-0.5 rounded-md ${issue.type === 'Error' ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700'
                                        }`}>
                                        {issue.type || "Info"}
                                    </span>
                                </div>
